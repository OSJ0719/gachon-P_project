...
public class KmaGridConverter {
    ...
    public static GridPoint toGrid(double lat, double lon) {
        ...
        // regionCode는 "nx_ny" 형식으로 사용 (캐시 키용)
        return new GridPoint(nx, ny, nx + "_" + ny);
    }

    public record GridPoint(int nx, int ny, String regionCode) {}
}
